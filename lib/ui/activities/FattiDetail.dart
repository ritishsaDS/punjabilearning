...
class FattiDetailScreen extends StatefulWidget {
  FattiDetailScreen({Key key, this.title, this.fattidetail}) : super(key: key);
  final String title;
  final dynamic fattidetail;
  @override
  _FattiDetailScreenState createState() => _FattiDetailScreenState();
}

class _FattiDetailScreenState extends State<FattiDetailScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: HtmlWidget(widget.fattidetail.name,
                              textStyle: TextStyle(
                                  fontSize: SizeConfig.blockSizeVertical * 15,
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              print(widget.fattidetail.audio);
                                  ...
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          SignatureDetailScreen(
                                            Signaturedetail: widget.fattidetail,
                                          )));
                            },
                            child: Container(
                              alignment: Alignment.centerLeft,
                      ...
                      Container(
                          ...
                          alignment: Alignment.centerLeft,
                          child: HtmlWidget(widget.fattidetail.description,
                              textStyle: TextStyle(
