...
import 'package:flutter_punjabilearning/ui/activities/LetterDetail.dart';
import 'package:flutter_punjabilearning/utils/SizeConfig.dart';
import 'package:flutter_widget_from_html_core/flutter_widget_from_html_core.dart';

class NumbersScreen extends StatefulWidget {
  NumbersScreen({Key key, this.title, this.detail, this.index})
      : super(key: key);
  final String title;
  final int index;
                    ...
                    return InkWell(
                      ...
                      child: Container(
                          ...
                          child: Container(
                            ...
                            child: HtmlWidget(
                                widget.detail.elementAt(index).title,
                                textStyle: TextStyle(
