...
import 'package:flutter_punjabilearning/ui/activities/FattiDetail.dart';
import 'package:flutter_punjabilearning/utils/SizeConfig.dart';
import 'package:flutter_widget_from_html_core/flutter_widget_from_html_core.dart';

class FattiScreen extends StatefulWidget {
  FattiScreen({Key key, this.title, this.detail, this.index}) : super(key: key);
  final String title;
  final int index;
  final List<Content> detail;
  @override
  _FattiScreenState createState() => _FattiScreenState();
}

class _FattiScreenState extends State<FattiScreen> {
