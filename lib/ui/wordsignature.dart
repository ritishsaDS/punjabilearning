...
class WordSignature extends StatefulWidget {
  dynamic name;
  WordSignature({this.name});
  @override
  _WordSignatureState createState() => _WordSignatureState();
}

class _WordSignatureState extends State<WordSignature> {
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        ...
                        size: SizeConfig.blockSizeVertical * 4.25,
                        color: Colors.white,
                      ),
                    ),
                  ),
